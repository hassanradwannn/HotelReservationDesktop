...
public class ReceptionistReservationCardController {
    ...
    public void setData(AppContext mainApp, Reservation reservation, String sourceTitle, Runnable refreshHandler) {
        setData(mainApp, reservation, null, sourceTitle, refreshHandler);
    }

    public void setData(AppContext mainApp, Reservation reservation, ReservationPaymentSummary paymentSummary,
