...
public class AdminMenuController {
    ...
    public void initData(Main mainApp, Admin admin) {
    ...
    @FXML private void showAddAmenity() { mainApp.switchDashboardContent(mainApp.getCurrentContentArea(), "/AddAmenity.fxml", null); }
